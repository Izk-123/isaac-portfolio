          ...
          >
            {projects.map(project => {
              ...
              return (
                ...
                >
                  {/* Neon border glow on hover - theme aware */}
                  <div 
                  ...
                  <div
                    className={`bg-gradient-to-br ${project.gradient} h-36 flex items-center justify-center text-5xl relative`}
                  >
                    {project.emoji}
                    {/* Spark effect */}
                    <motion.div
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      {project.demo && (
                        <Link
                          href={project.demo}
                          className="bg-blue-600 hover:bg-blue-500 text-white text-xs px-4 py-2 rounded-full transition-all duration-300 relative overflow-hidden group/btn"
                        >
                      ...
                      <Link
                        href={project.github}
                        target="_blank"
                        className="border border-slate-300 dark:border-white/20 hover:border-slate-400 dark:hover:border-white/50 text-slate-700 dark:text-white text-xs px-4 py-2 rounded-full transition-colors"
                      >
                        GitHub
                      </Link>
                    </div>
